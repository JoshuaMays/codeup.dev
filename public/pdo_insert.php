...
// SQL CREATE QUERY TO CREATE national_parks TABLE
$query = 'CREATE TABLE national_parks (
    id INT UNSIGNED NOT NULL AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL,
    location VARCHAR(50) NOT NULL,
    date_established DATE NOT NULL,
    area_in_acres FLOAT(15,2) UNSIGNED NOT NULL,
...
$parks = [
    ...
    ['name' => "Cuyahoga Valley", "location" => "Ohio", "date_established" => "2000-10-11", "area_in_acres" => 32860.73,"description" =>"This park along the Cuyahoga River has waterfalls, hills, trails, and exhibits on early rural living. The Ohio and Erie Canal Towpath Trail follows the Ohio and Erie Canal, where mules towed canal boats. The park has numerous historic homes, bridges, and structures, and also offers a scenic train ride."],
    ...
    ['name' => "Denali", "location" => "Alaska", "date_established" => "1917-09-12", "area_in_acres" => 337597.83,"description" =>"Centered around Mount McKinley, the tallest mountain in North America, Denali is serviced by a single road leading to Wonder Lake. McKinley and other peaks of the Alaska Range are covered with long glaciers and boreal forest. Wildlife includes grizzly bears, Dall sheep, caribou, and gray wolves."],
];

// SQL INSERT QUERY TO POPULATE national_parks TABLE WITH PARK DATA
// USING BOUND VARIABLES FOR INPUT VALUES
...
// LOOP THROUGH THE PARKS ARRAY TO BIND PARK DATA TO VARIABLE AND INSERT EACH RECORD
foreach($parks as $park) {
    $insert->bindValue(':name', $park['name'], PDO::PARAM_STR);
    $insert->bindValue(':location', $park['location'], PDO::PARAM_STR);
    $insert->bindValue(':date_established', $park['date_established'], PDO::PARAM_STR);
    $insert->bindValue(':area_in_acres', $park['area_in_acres'], PDO::PARAM_INT);
    $insert->bindValue(':description', $park['description'], PDO::PARAM_STR);
